...
publishedAt: 2026-07-06T09:14:52.000Z
category: "AI 底层原理连载"
tags: []
draft: false
...
**② 里面藏着三种不同的 Attention，不是一种。**前面第一章我们只讲了"一个字去看别的字"这一种。但原文的整车里，注意力被用在了三个完全不同的地方（编码器内部自己看自己、解码器内部带口罩地看自己、解码器扭头去看编码器）。第三种"扭头去看"，也就是 **Cross-Attention**（交叉注意力），是翻译能 work 的关键，前面完全没提。
...
> [!NOTE]
> **一句话讲完这一章**：这篇论文真正的贡献，与其说是"发明了注意力"，不如说是"**敢把 RNN 彻底删掉、用纯注意力搭出一台能并行的 Encoder-Decoder** 翻译机"。并行带来速度，双塔+三种注意力带来质量，后人把这台整车拆成 BERT / GPT / T5 三支，才有了今天的一切。
...
> [!NOTE]
> **下期预告 · 收尾篇**
> 正文到此全部讲完。最后一篇不讲新概念，是一张给你随时查的工程师速查卡，参数换显存、三大架构对比、术语英中对照，收藏向压轴。
